...
export const courses: Course[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: 'array', title: '7.1 Arreglos Fijos (Array)', href: '/course/cpp/array/', isSubItem: true },
      { slug: 'vector', title: '7.2 std::vector Dinámico', href: '/course/cpp/vector/', isSubItem: true },
      { slug: 'array-game', title: '7.3 Arreglos 2D (Pac-Man)', href: '/course/cpp/array-game/', isSubItem: true },
      { slug: 'array-examen', title: '7.4 Vector CRUD - Evaluación', href: '/course/cpp/array-examen/', isSubItem: true },
  ...
  },
  {
    slug: 'django',
    name: 'Django',
    description: 'Desarrollo backend con Python y Django: modelos, CRUD, APIs REST y seguridad.',
    category: 'advanced',
    status: 'available',
    color: '#0c4a3f',
    lessons: [
      { slug: 'introduccion', title: '1. Introducción', href: '/course/django/introduccion/' },
  ...
  {
    slug: 'tecnologias-servidor',
    name: 'Tecnologías del Lado del Servidor',
    description: 'Aprende cómo funciona Internet tras bambalinas: arquitectura cliente-servidor, HTTP/HTTPS, DNS, dominios, VPS/Cloud, Nginx/Apache y despliegue a producción.',
    category: 'advanced',
    status: 'available',
    color: '#1e293b',
    ...
    lessons: [
      ...
      { slug: 'https-y-certificados-ssl', title: '3. HTTPS y Certificados SSL/TLS', href: '/course/tecnologias-servidor/https-y-certificados-ssl/' },
      { slug: 'dns-y-resolucion-ip', title: '4. DNS y Resolución IP', href: '/course/tecnologias-servidor/dns-y-resolucion-ip/' },
      { slug: 'dominios-y-subdominios', title: '5. Dominios y Subdominios', href: '/course/tecnologias-servidor/dominios-y-subdominios/' },
      { slug: 'hosting-vps-y-cloud', title: '6. Hosting, VPS y Cloud', href: '/course/tecnologias-servidor/hosting-vps-y-cloud/' },
      { slug: 'servidores-web-nginx-apache', title: '7. Servidores Web (Nginx/Apache)', href: '/course/tecnologias-servidor/servidores-web-nginx-apache/' },
      { slug: 'stack-backend-y-tecnologias', title: '8. Stack Backend y BD', href: '/course/tecnologias-servidor/stack-backend-y-tecnologias/' },
      { slug: 'proyecto-despliegue-produccion', title: '9. Proyecto de Despliegue Web', href: '/course/tecnologias-servidor/proyecto-despliegue-produccion/' },
      { slug: 'diagnostico-y-dev-tools', title: '10. Diagnóstico y Monitoreo Web', href: '/course/tecnologias-servidor/diagnostico-y-dev-tools/' },
    ],
  },
  {
    slug: 'java',
    ...
    lessons: [
      ...
      { slug: 'poo-basico', title: '9. POO: Clases, Atributos y Constructores', href: '/course/java/poo-basico/' },
      { slug: 'herencia-polimorfismo', title: '10. Herencia y Polimorfismo (Vehículo, Auto, Moto)', href: '/course/java/herencia-polimorfismo/' },
      { slug: 'interfaces-contratos', title: '11. Interfaces y Contratos', href: '/course/java/interfaces-contratos/' },
      { slug: 'composicion-agregacion', title: '12. Composición, Agregación y Arreglos de Objetos', href: '/course/java/composicion-agregacion/' },
