...
export const courses: Course[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: 'listas', title: '3. Listas y Tuplas', href: '/course/python/listas/' },
      { slug: 'diccionarios', title: '4. Diccionarios', href: '/course/python/diccionarios/' },
      { slug: 'condicionales', title: '5. Lógica (If)', href: '/course/python/condicionales/' },
      { slug: 'bucles', title: '6. Bucles (For/While)', href: '/course/python/bucles/' },
      { slug: 'funciones', title: '7. Funciones', href: '/course/python/funciones/' },
      { slug: 'list-comprehension', title: '8. List Comprehension', href: '/course/python/list-comprehension/' },
      { slug: 'poo', title: '9. Clases y Objetos', href: '/course/python/poo/' },
      { slug: 'modulos', title: '10. Módulos y PIP', href: '/course/python/modulos/' },
    ],
  },
  {
    slug: 'java',
