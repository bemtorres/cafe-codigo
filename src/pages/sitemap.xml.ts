...
const STATIC_PAGES: { path: string; priority: string; changefreq: string }[] = [
  ...
  { path: '/academia/unirse/', priority: '0.8', changefreq: 'monthly' },
  { path: '/academico/', priority: '0.7', changefreq: 'monthly' },
  { path: '/cafe-del-dia/', priority: '0.8', changefreq: 'daily' },
  { path: '/colaboradores/', priority: '0.6', changefreq: 'monthly' },
  { path: '/landing/', priority: '0.7', changefreq: 'monthly' },
  { path: '/landing2/', priority: '0.7', changefreq: 'monthly' },

  // Motor y Herramientas Interactivas
  { path: '/engine/relational-database/', priority: '0.8', changefreq: 'weekly' },

  // Ejercicios
  { path: '/ejercicios/', priority: '0.8', changefreq: 'weekly' },
  { path: '/ejercicios/unidad-1/', priority: '0.7', changefreq: 'monthly' },
  { path: '/ejercicios/unidad-2/', priority: '0.7', changefreq: 'monthly' },
  { path: '/ejercicios/unidad-3/', priority: '0.7', changefreq: 'monthly' },
  { path: '/ejercicios/unidad-4/', priority: '0.7', changefreq: 'monthly' },

  // Desafíos / Challenges (Core & POO)
  ...
  { path: '/challenges/database/', priority: '0.9', changefreq: 'weekly' },
  { path: '/challenges/poo/', priority: '0.9', changefreq: 'weekly' },
  { path: '/challenges/poo-game/', priority: '0.9', changefreq: 'weekly' },
  ...
  // Desafíos Express
  { path: '/challenges-express/', priority: '0.9', changefreq: 'weekly' },
  { path: '/challenges-express/algoritmos/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/arreglos/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/bucles/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/condicionales/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/django/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/excepciones/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/funciones/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/matrices/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/poo/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/terminal/', priority: '0.8', changefreq: 'weekly' },
  { path: '/challenges-express/variables/', priority: '0.8', changefreq: 'weekly' },

  // Desafíos Gamer y Juegos de Lógica
  ...
  { path: '/challenges-game/vectors-crud-exam/', priority: '0.9', changefreq: 'weekly' },
  { path: '/arreglos-game/', priority: '0.9', changefreq: 'weekly' },
];
